...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4">
      {/* Background effects */}
      <div id="particles" className="absolute top-0 left-0 w-full h-full z-0 overflow-hidden"></div>
      ...
      <div className="bg-gray-900 bg-opacity-80 backdrop-blur-lg rounded-xl p-6 sm:p-8 w-full max-w-md z-10 relative border border-gray-700 shadow-xl">
        ...
        <div className="relative flex items-center justify-center my-6">
          ...
          <span className="text-gray-500 text-sm bg-gray-900 px-3 absolute">Or continue with</span>
        </div>
